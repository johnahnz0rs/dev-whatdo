...
<div id="component-wins">
    ...
    echo '<div id="win-' . $win['id'] . '" class="row full-width p-3 my-3">';
        ...
        echo '<div class="col col-12 col-md-10 col-lg-6 bg-secondary text-light p-3">';
            echo '<div class="d-flex justify-content-center align-items-baseline">';
                ...
                echo '<div class="col-9">';
                    ...
                    echo '<p id="winnote-' . $win['id'] . '" style="display: none;">' . $win['note'] . '</p>';
                    echo '<small class="toggle-win-note" data-id="' . $win['id'] . '"><em> show / hide note </em></small>';
...
$( document ).ready( function() {
    ...
    $( '.toggle-win-note' ).on( 'click', function() {
        const formToBeToggled = '#formeditwin-' + $( this ).data( 'id' );
